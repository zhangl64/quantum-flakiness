...
| Qiskit  | Qiskit-Terra | <ul><il>[#9023](https://github.com/Qiskit/qiskit-terra/pull/9023)</il><il>[#9021](https://github.com/Qiskit/qiskit-terra/pull/9021)</il></ul> |   | Assertion | Loose the thresholds of an assertion |
